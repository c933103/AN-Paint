...
class PaintCanvas(context: Context, val document: PaintDocument) : View(context) {
    ...
    fun restoreDraft(state: JSONObject) {
        ...
        cursorShape=state.optInt("cursor_shape",document.brushTip.coerceIn(0,1)).coerceIn(0,1)
