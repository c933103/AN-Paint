...
File > About. AN Paint modifications are dated 7–16 September 2026.
...
Main-menu completion, Armenian vocabulary and regional/script adaptations in
translations/main-menu-translations.json are by AN Paint contributors (2026),
AGPL-3.0-or-later. Existing source translator credits above and below are retained.
...
original notices and modification details follow below.
...
Optional online illustrations come from Catrobat, Irasutoya and Openclipart.
Their images are not bundled. Source pages, asset links and editable credits
are kept under File > About > Image credits.
Catrobat's own non-software artwork uses CC BY-SA 4.0, except names/logos and
separately credited works: https://developer.catrobat.org/pages/legal/licenses/catrobat/
Irasutoya artwork is copyright Takashi Mifune, with free use subject to its
custom terms; commercial designs using 21 or more items require payment.
Special collaborations can have separate conditions. It is not CC BY-SA or CC0.
https://www.irasutoya.com/p/terms.html
Openclipart publishes artwork under CC0; individual contributor/source pages
are preserved: https://openclipart.org/share
